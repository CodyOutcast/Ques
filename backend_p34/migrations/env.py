...
# from models.chats import Chat  # Commented out to avoid Message conflict
...
from models.users import User, UserFeature, UserSwipe, UserLink  # Import all User models
import os

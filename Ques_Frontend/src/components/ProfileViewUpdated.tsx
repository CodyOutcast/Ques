...
import { Edit, User, Briefcase, Target, GraduationCap, Globe, Clock, Heart, MapPin, Building, Camera, Info, Package, Search, Sparkles } from 'lucide-react';
          ...
          <>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-medium">AI Profile Suggestions</h3>
              </div>
              
              <div className="space-y-4 max-h-96 overflow-y-auto">
                <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-4 border border-purple-200">
                  <h4 className="text-sm font-medium text-purple-800 mb-2">🚀 Boost Your Visibility</h4>
                  <ul className="text-xs text-purple-700 space-y-1">
                    <li>• Add 2-3 more skills to increase match accuracy by 40%</li>
                    <li>• Include a recent project to showcase your capabilities</li>
                    <li>• Specify your current goals for better AI recommendations</li>
                  </ul>
                </div>

                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  <h4 className="text-sm font-medium text-green-800 mb-2">🎯 Optimize For Co-founders</h4>
                  <ul className="text-xs text-green-700 space-y-1">
                    <li>• Highlight complementary skills (design + tech works great)</li>
                    <li>• Add resources you can offer (funding, network, expertise)</li>
                    <li>• Be specific about what you're seeking in demands</li>
                  </ul>
                </div>

                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <h4 className="text-sm font-medium text-blue-800 mb-2">💼 Professional Polish</h4>
                  <ul className="text-xs text-blue-700 space-y-1">
                    <li>• Verify your university email for +20% trust score</li>
                    <li>• Add past institutions to build credibility</li>
                    <li>• Include reference links for your projects</li>
                  </ul>
                </div>

                <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                  <h4 className="text-sm font-medium text-orange-800 mb-2">✨ Stand Out Tips</h4>
                  <ul className="text-xs text-orange-700 space-y-1">
                    <li>• Your one-sentence intro is your first impression</li>
                    <li>• Show personality through hobbies and interests</li>
                    <li>• Be authentic - genuine profiles get better matches</li>
                  </ul>
                </div>
              </div>

...
export function ProfileSetupWizard({ onComplete, onBack }: ProfileSetupWizardProps) {
  ...
  }, [currentStep, steps.length, onComplete, profile, currentUniversity, emailVerified]);
  ...
  const canProceed = useCallback(() => {
    switch (currentStep) {
      case 0: return profile.name && profile.age && profile.gender && profile.location;
      case 1: return true;
      case 2: return true;
      case 3: return true;
        ...
        <div className="col-span-1 flex flex-col items-center">
          <div className="relative">
            <Avatar className="w-14 h-14">
              ...
              <AvatarFallback>
                {profile.name ? profile.name[0].toUpperCase() : <Camera size={18} />}
              </AvatarFallback>
            </Avatar>
            <Button 
              size="sm" 
  ...
  const renderAuthentication = useCallback(() => (
    <div className="text-center space-y-6 py-8">
      <div>
        ...
        <h2>Almost done!</h2>
        <p className="text-sm text-gray-500">Ready to join the Ques community</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
          ...
          <span className="text-sm">WeChat integration ready</span>
        </div>
      </div>

      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            style={{ 
              zIndex: 10000,
              width: 'calc(min(100vw, 600px) - 2rem)',
              maxWidth: 'calc(min(100vw, 600px) - 2rem)'
            }}
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                {message && message === defaultMessage && (
                  <div className="flex items-center gap-1.5 mb-2 text-xs text-purple-600 bg-purple-50 px-2 py-1.5 rounded-md">
                    <Sparkles size={12} className="flex-shrink-0" />
                    <span>{t('whisper.aiGenerated') || 'Default message generated by AI based on your match'}</span>
                  </div>
                )}
                ...
                <div className="flex items-center justify-between mt-1">
                  <p className="text-xs text-gray-500">{t('whisper.messageHelper')}</p>

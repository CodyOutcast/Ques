...
class UserAuth(Base):
    ...
    provider_id = Column(String(255), nullable=False)  # wechat_id, phone number
    password_hash = Column(String(255), nullable=True)  # not used for WECHAT/PHONE providers
...
class VerificationCode(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    provider_type = Column(Enum(ProviderType), nullable=False)
    provider_id = Column(String(255), nullable=False)  # wechat_id or phone

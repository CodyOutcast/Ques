"""
Test content moderation with correct Tencent Cloud TMS API
"""
import asyncio
import os
import sys
...
async def test_tms_moderation():
    """Test content moderation with Tencent TMS API"""
    ...
    class TencentTMSService:
        def __init__(self, settings):
            ...
            self.service = "tms"  # Use TMS service instead of CMS
        ...
        async def moderate_text(self, text: str, user_id: Optional[str] = None) -> ModerationResult:
            ...
            try:
                ...
                headers = {
                    ...
                    "Host": self.host,
                    "X-TC-Action": "TextModeration",  # This should work with TMS
                    "X-TC-Timestamp": str(timestamp),
                    "X-TC-Version": "2020-07-13",  # TMS version
                    "X-TC-Region": self.region
                }
                
                print(f"Making TMS API call to {self.endpoint}")
                print(f"Action: TextModeration, Version: 2020-07-13")
                ...
                confidence = 1.0 if suggestion in ["Pass", "Block"] else 0.7
    ...
    print("🧪 Testing Content Moderation with Tencent TMS API")
    print("=" * 60)
    ...
    if blocked_count == 0 and approved_count == len(test_cases):
        ...
        print("     1. Content moderation is in fallback mode (check credentials)")
        print("     2. The test content isn't triggering Tencent's filters")
        print("     3. API configuration needs adjustment")
    elif blocked_count > 0:
        print()
        print("✅ Content moderation is working!")
        print("   - Some inappropriate content was blocked")
...
if __name__ == "__main__":
    asyncio.run(test_tms_moderation())

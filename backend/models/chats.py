...
class Chat(Base):
    ...
    user1_id = Column(Integer, ForeignKey("users.id"), nullable=False)  # One participant
    user2_id = Column(Integer, ForeignKey("users.id"), nullable=False)  # Other participant

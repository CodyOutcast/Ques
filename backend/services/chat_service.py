"""
Chat service handling greeting/acceptance flow and messaging
"""
...
class ChatService:
    ...
    @staticmethod
    def send_greeting(db: Session, sender_id: int, greeting_data: GreetingCreate) -> ChatResponse:
        """
        Send a greeting message to start a chat
    ...
    @staticmethod
    def send_message(db: Session, sender_id: int, chat_id: int, message_data: MessageCreate) -> MessageResponse:
        """

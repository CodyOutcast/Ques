import svgPaths from "./svg-rxmtdc5uq4";
// Placeholder image URL
const imgRectangle2 = "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&h=200&fit=crop";

function SolarArrowLeftOutline() {
  return (
    <div className="relative size-full" data-name="solar:arrow-left-outline">
...
function WeuiSettingOutlined() {
  return (
    <div className="relative size-full" data-name="weui:setting-outlined">
      <div className="absolute inset-[8.333%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
          <path clipRule="evenodd" d={svgPaths.pff4bc00} fill="var(--fill-0, black)" fillRule="evenodd" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Frame251() {
  return (
    <div className="absolute content-stretch flex gap-[66px] items-center justify-start left-[17px] top-[25px]">
      ...
      <div className="relative shrink-0 size-6" data-name="weui:setting-outlined">
        <WeuiSettingOutlined />
      </div>
    </div>
  );
...
function Frame253() {
  return (
    <div className="content-stretch flex gap-3 items-start justify-start relative shrink-0">
      <GenericAvatar />
      <Text />
      <div className="bg-center bg-cover bg-no-repeat rounded-[10px] shrink-0 size-11" style={{ backgroundImage: `url('${imgRectangle2}')` }} />
    </div>
  );
}
...
function SnackbarButCooler() {
  return (
    <div className="bg-[#ffffff] relative rounded shrink-0 w-full" data-name="Snackbar but Cooler">
      <div aria-hidden="true" className="absolute border border-[#0088ff] border-solid inset-0 pointer-events-none rounded" />

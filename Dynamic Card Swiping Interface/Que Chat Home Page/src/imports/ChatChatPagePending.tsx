import svgPaths from "./svg-99vtvx8zq1";
...
function Frame19() {
  return (
    <div className="content-stretch flex items-center justify-start relative shrink-0 w-[81px]">
      <IconButton />
      <IconButton1 />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start justify-start leading-[0] relative shrink-0 text-nowrap">
      ...
      <div className="font-['Instrument_Sans:Italic',_sans-serif] font-normal italic relative shrink-0 text-[#0055f7] text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] text-nowrap whitespace-pre">Waiting for reply</p>
      </div>
    </div>
  );
}
...
function RiMoreFill() {
  return (
    <div className="relative shrink-0 size-6" data-name="ri:more-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ri:more-fill">
          <path d={svgPaths.p381af400} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function CharmTickDouble() {
  return (
    <div className="relative shrink-0 size-3" data-name="charm:tick-double">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="charm:tick-double">
          <path d={svgPaths.pabf9680} id="Vector" stroke="var(--stroke-0, #8593A8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.125" />
          <path d={svgPaths.pabf9680} id="Vector_2" stroke="var(--stroke-0, #8593A8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.125" />
        </g>
      </svg>
    </div>
  );
...
function Frame26() {
  return (
    <div className="bg-[#0055f7] box-border content-stretch flex gap-2.5 items-center justify-start overflow-clip p-[12px] relative rounded-bl-[30px] rounded-tl-[30px] rounded-tr-[30px] shrink-0">
      <div className="capitalize font-['Instrument_Sans:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#f2f2f2] text-[12px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre">Hi! I’m interested in your project. Wanna have a look.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex gap-2.5 items-start justify-start overflow-clip px-[5px] py-0.5 relative rounded-bl-[8px] rounded-br-[8px] shrink-0">
      <div className="capitalize font-['Instrument_Sans:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[#3d3d3d] text-[7px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre">10:30</p>
      </div>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="content-stretch flex flex-col h-[52px] items-end justify-start relative shrink-0 w-[357px]">
      <Frame249 />
      <Frame28 />
    </div>
  );
...
function Frame250() {
  return (
    <div className="absolute box-border content-stretch flex gap-[302px] h-6 items-center justify-start left-[18.5px] px-1 py-3 top-[147px] w-[356px]">
      <div className="absolute flex flex-col font-['Instrument_Sans:Italic',_sans-serif] font-normal h-6 italic justify-center leading-[0] left-[178px] text-[#8e8e93] text-[12px] text-center top-3 translate-x-[-50%] translate-y-[-50%] w-[356px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal]">You can only send 1 message before the other replies</p>
      </div>
      <div className="h-0 relative shrink-0 w-[20.017px]">
        <div className="absolute bottom-0 left-0 right-0 top-[-0.8px]" style={{ "--stroke-0": "rgba(174, 174, 178, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 1">
            <line id="Line 1" stroke="var(--stroke-0, #AEAEB2)" strokeWidth="0.8" x2="20.0171" y1="0.6" y2="0.6" />
          </svg>
        </div>
      </div>
      <div className="h-0 relative shrink-0 w-[23.022px]">
        <div className="absolute bottom-0 left-0 right-0 top-[-0.8px]" style={{ "--stroke-0": "rgba(174, 174, 178, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 1">
            <line id="Line 2" stroke="var(--stroke-0, #AEAEB2)" strokeWidth="0.8" x2="23.0217" y1="0.6" y2="0.6" />
          </svg>
        </div>
      </div>
    </div>
...
function Depth3Frame0() {
  return (
    <div className="content-stretch flex flex-col gap-1 items-center justify-end relative rounded-2xl shrink-0 w-[65.2px]" data-name="Depth 3, Frame 0">
      <Depth4Frame0 />
    </div>
  );
}
...
function Screen() {
  return (
    <div className="absolute bg-[#ffffff] bottom-0 content-stretch flex flex-col items-center justify-start left-1 overflow-clip right-[5px] top-0" data-name="Screen">
      <UpperBar />
      <MainContent />
      <NevigationBar />
    </div>
...
function Frame35() {
  return (
    <div className="absolute bg-[#ffffff] box-border content-stretch flex gap-2 h-[46px] items-center justify-start left-[27px] pl-[22px] pr-0 py-0 rounded-[30px] top-[686px] w-[347px]">
...
export default function ChatChatPagePending() {
  return (
    <div className="relative size-full" data-name="chat-chat page-pending">
      <Screen />
      <Frame35 />
    </div>
  );

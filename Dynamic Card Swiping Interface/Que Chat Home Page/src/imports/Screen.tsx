import svgPaths from "./svg-tqxitiqz9z";
...
function Frame14() {
  return <div className="absolute h-[663px] left-[7px] top-0 w-[379px]" />;
}
...
export default function Screen() {
  return (
    <div className="bg-[#ffffff] content-stretch flex flex-col items-center justify-start relative size-full" data-name="Screen">
      <UpperBar />
      <MainContent />
      <NevigationBar />
    </div>

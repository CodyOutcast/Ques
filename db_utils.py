...
# Import tcvectordb with error handling
try:
    import tcvectordb
    ...
    logging.warning("Vector DB features will not work properly")
...
# Import from backend_merged dependencies
...
def get_vdb_client():
    if not TCVECTORDB_AVAILABLE:
        raise RuntimeError("tcvectordb not available. Vector DB features disabled.")
